...
class DplReactAppsController extends ControllerBase {
  ...
  public function search(): array {
    $data = [
      ...
      'number-description-text' => $this->t('@count', [], ['context' => 'Search Result']),
      ...
      'search-can-always-be-loaned-description-text' => $this->t('Only show materials that can always be loaned', [], ['context' => 'Search Result']),
      'search-dialog-filter-materials-text' => $this->t('Filter materials', [], ['context' => 'Search Result']),
      ...
      'search-showing-materials-text' => $this->t('@hitcount materials', [], ['context' => 'Search Result']),
      'search-sorting-option-text' => $this->t('Sorting', [], ['context' => 'Search Result']),
